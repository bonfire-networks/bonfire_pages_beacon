...
```
cd forks
git clone https://github.com/bonfire-networks/bonfire_pages_beacon.git {your-extension-name-here}
cd {your-extension-name-here} 
```
- Rename all the modules names to match your extension name:
    - Find & replace Pages.Beacon -> YourExtensionName 
    - Find & replace bonfire_pages_beacon -> bonfire_your_extension_name
- Rename the `bonfire_pages_beacon.exs` config file to match your extension name `bonfire_your_extension_name.exs`
...
- Add `use_if_enabled(Bonfire.Pages.Beacon.Web.Routes)` in your app's `Router` module
